...
# flyta med, och inte heller husen: molnen forskjuts upp till ~65 px, sa masken tonas ut
# pa 80 px fran dem. Galaxen ar en sned ellips, uppmatt i 1672x1300.
...
MOLN_FRI = 80                         # sa langt fran galax, mane och hus borjar molnen rora sig
